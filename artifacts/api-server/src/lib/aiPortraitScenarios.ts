...
export const INJECTOR_COLLECTION_PRESETS: PhotoStudioPreset[] = [
  ...
  {
    id: "ic-106",
    name: "Art Deco - Feathered Headpiece",
    hasColour: false,
    promptTemplate: `An ultra-realistic glamorous editorial portrait of the person from the reference photo in 1920s flapper-inspired art deco styling with an elegant feathered and beaded headpiece and a bright jewel-toned dress, against a black background with gold deco accents. Warm soft glamour lighting. Close head and shoulders. Realistic skin and texture detail, editorial quality. Same facial features as reference photo.`,
  },
  {
    id: "ic-107",
