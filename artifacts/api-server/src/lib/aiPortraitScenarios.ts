...
export const HOMEWORK_SHOTS_PRESETS: PhotoStudioPreset[] = [
  {
    ...
    hasColour: false,
    promptTemplate: `A woman from the reference photo, wearing a fitted black long-sleeve dress, standing in a bright, modern clinic treatment room with soft neutral walls and clean white cabinetry just visible in the background, soft natural daylight, shot like an authentic phone photo for social media content, both index fingers extended and pointing straight down toward the bottom of the frame as if directing the viewer to read a caption below, relaxed confident expression. Hyper-realistic unretouched skin texture with visible pores, no airbrushing, no smoothing, no glamming up. Same facial features as reference photo.`,
  },
  {
    id: "hw-02",
    name: "Homework Shots 02 - Point To The Side",
    hasColour: false,
    promptTemplate: `A woman from the reference photo, wearing a fitted black long-sleeve dress, standing in a bright, modern clinic treatment room with soft neutral walls and clean white cabinetry just visible in the background, soft natural daylight, shot like an authentic phone photo for social media content, one hand raised to chest height with the index finger pointing off to the side as if directing attention to something out of frame, slight smile. Hyper-realistic unretouched skin texture with visible pores, no airbrushing, no smoothing, no glamming up. Same facial features as reference photo.`,
  },
  {
    id: "hw-03",
    name: "Homework Shots 03 - Point Behind/Beside",
    hasColour: false,
    promptTemplate: `A woman from the reference photo, wearing a fitted black long-sleeve dress, standing in a bright, modern clinic treatment room with soft neutral walls and clean white cabinetry just visible in the background, soft natural daylight, shot like an authentic phone photo for social media content, turned slightly to one side with an arm raised and index finger pointing up and back over her shoulder as if showing off something behind her, playful raised eyebrow. Hyper-realistic unretouched skin texture with visible pores, no airbrushing, no smoothing, no glamming up. Same facial features as reference photo.`,
  },
  {
    id: "hw-04",
    name: "Homework Shots 04 - Point Up (Both Hands)",
    hasColour: false,
    promptTemplate: `A woman from the reference photo, wearing a fitted black long-sleeve dress, standing in a bright, modern clinic treatment room with soft neutral walls and clean white cabinetry just visible in the background, soft natural daylight, shot like an authentic phone photo for social media content, both arms raised above her head with both index fingers pointing straight up as if directing the viewer to a headline above, big confident energy. Hyper-realistic unretouched skin texture with visible pores, no airbrushing, no smoothing, no glamming up. Same facial features as reference photo.`,
  },
  {
    id: "hw-05",
    name: "Homework Shots 05 - Hold Up Tablet",
    hasColour: false,
    promptTemplate: `A woman from the reference photo, wearing a fitted black long-sleeve dress, standing in a bright, modern clinic treatment room with soft neutral walls and clean white cabinetry just visible in the background, soft natural daylight, shot like an authentic phone photo for social media content, holding a black tablet up at chest height with both hands, screen facing the camera, as if about to present information on the screen. Hyper-realistic unretouched skin texture with visible pores, no airbrushing, no smoothing, no glamming up. Same facial features as reference photo.`,
  },
  {
    id: "hw-06",
    name: "Homework Shots 06 - Hands On Hips",
    hasColour: false,
    promptTemplate: `A woman from the reference photo, wearing a fitted black long-sleeve dress, standing in a bright, modern clinic treatment room with soft neutral walls and clean white cabinetry just visible in the background, soft natural daylight, shot like an authentic phone photo for social media content, standing with both hands on her hips in a confident power stance, shoulders back, chin slightly raised. Hyper-realistic unretouched skin texture with visible pores, no airbrushing, no smoothing, no glamming up. Same facial features as reference photo.`,
  },
  {
    id: "hw-07",
    name: "Homework Shots 07 - Arms Crossed",
    hasColour: false,
    promptTemplate: `A woman from the reference photo, wearing a fitted black long-sleeve dress, standing in a bright, modern clinic treatment room with soft neutral walls and clean white cabinetry just visible in the background, soft natural daylight, shot like an authentic phone photo for social media content, arms folded loosely across her chest, warm approachable smile, relaxed posture. Hyper-realistic unretouched skin texture with visible pores, no airbrushing, no smoothing, no glamming up. Same facial features as reference photo.`,
  },
  {
    id: "hw-08",
    name: "Homework Shots 08 - Friendly Wave",
    hasColour: false,
    promptTemplate: `A woman from the reference photo, wearing a fitted black long-sleeve dress, standing in a bright, modern clinic treatment room with soft neutral walls and clean white cabinetry just visible in the background, soft natural daylight, shot like an authentic phone photo for social media content, one hand raised beside her head in a friendly wave, warm open smile as if greeting the viewer. Hyper-realistic unretouched skin texture with visible pores, no airbrushing, no smoothing, no glamming up. Same facial features as reference photo.`,
  },
  {
    id: "hw-09",
    name: "Homework Shots 09 - Thinking Pose",
    hasColour: false,
    promptTemplate: `A woman from the reference photo, wearing a fitted black long-sleeve dress, standing in a bright, modern clinic treatment room with soft neutral walls and clean white cabinetry just visible in the background, soft natural daylight, shot like an authentic phone photo for social media content, one hand resting lightly on her chin, head tilted slightly, thoughtful considering expression as if weighing up an idea. Hyper-realistic unretouched skin texture with visible pores, no airbrushing, no smoothing, no glamming up. Same facial features as reference photo.`,
  },
  {
    id: "hw-10",
    name: "Homework Shots 10 - Double Thumbs Up",
    hasColour: false,
    promptTemplate: `A woman from the reference photo, wearing a fitted black long-sleeve dress, standing in a bright, modern clinic treatment room with soft neutral walls and clean white cabinetry just visible in the background, soft natural daylight, shot like an authentic phone photo for social media content, both thumbs up at chest height, bright enthusiastic smile, energetic expression. Hyper-realistic unretouched skin texture with visible pores, no airbrushing, no smoothing, no glamming up. Same facial features as reference photo.`,
  },
  {
    id: "hw-11",
    name: "Homework Shots 11 - Shh Secret Tip",
    hasColour: false,
    promptTemplate: `A woman from the reference photo, wearing a fitted black long-sleeve dress, standing in a bright, modern clinic treatment room with soft neutral walls and clean white cabinetry just visible in the background, soft natural daylight, shot like an authentic phone photo for social media content, one index finger raised to her lips in a playful "shh, here's a secret" gesture, eyes bright and mischievous. Hyper-realistic unretouched skin texture with visible pores, no airbrushing, no smoothing, no glamming up. Same facial features as reference photo.`,
  },
  {
    id: "hw-12",
    name: "Homework Shots 12 - Product Showcase",
    hasColour: false,
    promptTemplate: `A woman from the reference photo, wearing a fitted black long-sleeve dress, standing in a bright, modern clinic treatment room with soft neutral walls and clean white cabinetry just visible in the background, soft natural daylight, shot like an authentic phone photo for social media content, holding a small unbranded skincare bottle up beside her face at shoulder height, showing it off to the camera with a pleased expression. Hyper-realistic unretouched skin texture with visible pores, no airbrushing, no smoothing, no glamming up. Same facial features as reference photo.`,
  },
  {
    id: "hw-13",
    name: "Homework Shots 13 - Seated With Clipboard",
    hasColour: false,
    promptTemplate: `A woman from the reference photo, wearing a fitted black long-sleeve dress, standing in a bright, modern clinic treatment room with soft neutral walls and clean white cabinetry just visible in the background, soft natural daylight, shot like an authentic phone photo for social media content, seated on a stool with a clipboard resting on her lap, one hand holding a pen above it, looking up at the camera with a friendly professional expression. Hyper-realistic unretouched skin texture with visible pores, no airbrushing, no smoothing, no glamming up. Same facial features as reference photo.`,
  },
  {
    id: "hw-14",
    name: "Homework Shots 14 - Candid Laugh Over Shoulder",
    hasColour: false,
    promptTemplate: `A woman from the reference photo, wearing a fitted black long-sleeve dress, standing in a bright, modern clinic treatment room with soft neutral walls and clean white cabinetry just visible in the background, soft natural daylight, shot like an authentic phone photo for social media content, body turned away from camera and glancing back over one shoulder with a genuine candid laugh, natural movement in her hair. Hyper-realistic unretouched skin texture with visible pores, no airbrushing, no smoothing, no glamming up. Same facial features as reference photo.`,
  },
  {
    id: "hw-15",
    name: "Homework Shots 15 - Heart Hands",
    hasColour: false,
    promptTemplate: `A woman from the reference photo, wearing a fitted black long-sleeve dress, standing in a bright, modern clinic treatment room with soft neutral walls and clean white cabinetry just visible in the background, soft natural daylight, shot like an authentic phone photo for social media content, both hands held together at chest height forming a heart shape, soft warm smile. Hyper-realistic unretouched skin texture with visible pores, no airbrushing, no smoothing, no glamming up. Same facial features as reference photo.`,
  },
  {
    id: "hw-16",
    name: "Homework Shots 16 - Presenting Gesture",
    hasColour: false,
    promptTemplate: `A woman from the reference photo, wearing a fitted black long-sleeve dress, standing in a bright, modern clinic treatment room with soft neutral walls and clean white cabinetry just visible in the background, soft natural daylight, shot like an authentic phone photo for social media content, standing side-on to the camera with one arm extended and palm open toward the empty space beside her, as if presenting something on an invisible screen or whiteboard. Hyper-realistic unretouched skin texture with visible pores, no airbrushing, no smoothing, no glamming up. Same facial features as reference photo.`,
  },
  {
    id: "hw-17",
    name: "Homework Shots 17 - Walking Towards Camera",
    hasColour: false,
    promptTemplate: `A woman from the reference photo, wearing a fitted black long-sleeve dress, standing in a bright, modern clinic treatment room with soft neutral walls and clean white cabinetry just visible in the background, soft natural daylight, shot like an authentic phone photo for social media content, captured mid-stride walking naturally toward the camera, one foot forward, relaxed confident movement, slight motion in her hair and dress. Hyper-realistic unretouched skin texture with visible pores, no airbrushing, no smoothing, no glamming up. Same facial features as reference photo.`,
  },
  {
    id: "hw-18",
    name: "Homework Shots 18 - Applying Product",
    hasColour: false,
    promptTemplate: `A woman from the reference photo, wearing a fitted black long-sleeve dress, standing in a bright, modern clinic treatment room with soft neutral walls and clean white cabinetry just visible in the background, soft natural daylight, shot like an authentic phone photo for social media content, dabbing a small amount of cream onto her own cheek with two fingers, eyes closed or looking at the camera with a serene expression. Hyper-realistic unretouched skin texture with visible pores, no airbrushing, no smoothing, no glamming up. Same facial features as reference photo.`,
  },
  {
    id: "hw-19",
    name: "Homework Shots 19 - Before and After Reveal",
    hasColour: false,
    promptTemplate: `A woman from the reference photo, wearing a fitted black long-sleeve dress, standing in a bright, modern clinic treatment room with soft neutral walls and clean white cabinetry just visible in the background, soft natural daylight, shot like an authentic phone photo for social media content, holding a tablet at chest height showing a blank screen and tapping it with one finger from the other hand, engaged explaining expression as if walking through a before-and-after result. Hyper-realistic unretouched skin texture with visible pores, no airbrushing, no smoothing, no glamming up. Same facial features as reference photo.`,
  },
  {
    id: "hw-20",
    name: "Homework Shots 20 - Casual Lean",
    hasColour: false,
    promptTemplate: `A woman from the reference photo, wearing a fitted black long-sleeve dress, standing in a bright, modern clinic treatment room with soft neutral walls and clean white cabinetry just visible in the background, soft natural daylight, shot like an authentic phone photo for social media content, leaning casually against a treatment couch or counter edge with arms loosely crossed, one ankle crossed over the other, relaxed confident smile. Hyper-realistic unretouched skin texture with visible pores, no airbrushing, no smoothing, no glamming up. Same facial features as reference photo.`,
  },
];
