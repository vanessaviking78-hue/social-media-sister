...
export const ALL_FONTS = [
  ...
  { label: "Prata",            value: "Prata",            cat: "Serif"  },
...
export const FONT_PAIRINGS: Record<string, string> = {
    "'Lora', serif":                       "'Work Sans', sans-serif",
