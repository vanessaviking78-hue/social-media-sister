...
icon: FileText,
name: "CSV Creator",
description: "Type in an area, a client's website and what you want, and it writes a 4-slide carousel CSV ready for the builder.",
color: "from-teal-500/20 to-teal-500/5",
border: "hover:border-teal-500/50",
iconColor: "text-teal-400",
},
...
icon: Palette,
name: "Stylish",
description: "Full bleed photo carousels in bulk. Upload photos and a CSV, pick your fonts and colours, write the captions, then download or schedule.",
color: "from-sky-500/20 to-sky-500/5",
border: "hover:border-sky-500/50",
iconColor: "text-sky-400",
},
...
description: "Turn a clinician into a cartoon and post a two slide comic with a punchline about aesthetics safety. 40 conversations, 1080 x 1440, caption included.",
color: "from-yellow-500/20 to-yellow-500/5",
border: "hover:border-yellow-500/50",
iconColor: "text-yellow-400",
},
