...
export default function GoogleOAuthResult() {
    ...
    if (isSuccess) {
      if (window.opener) {
        window.opener.postMessage(
          { type: "google-oauth-result", success: true },
      ...
      if (window.opener) {
        window.opener.postMessage(
          { type: "google-oauth-result", success: false, error: errorMsg },
          window.location.origin
        );
      }
    }
      ...
      <div className="max-w-sm w-full bg-gray-900 rounded-2xl p-8 space-y-5 border border-gray-800 shadow-2xl">
        ...
        {isSuccess && (
          <div className="text-center space-y-3">
            ...
            <h2 className="text-xl font-bold">Google Calendar Connected</h2>
            <p className="text-gray-400 text-sm">
              You can now offer Brainstorm call bookings straight to your calendar.
            </p>
