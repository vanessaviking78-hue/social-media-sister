...
const FEATURES = [
  {
    Icon: IconGrid,
    title: "Bulk carousel generation",
    desc: "Upload one photo, pick your style, and generate 60 fully-branded posts in the time it used to take you to make one.",
  },
  {
    Icon: IconSliders,
    title: "Client brand presets",
    desc: "Every clinic's colours, fonts, and logo locked in once. Switch between accounts in seconds. No rebriefing yourself every Monday.",
  },
  {
    Icon: IconSparkle,
    title: "AI portrait studio",
    desc: "Professional headshots without booking a photographer. On-brand portraits for any scenario, ready when you need them.",
  },
  {
    Icon: IconCalendar,
    title: "Plan and schedule",
    desc: "A content calendar built for social media managers. Map out months in advance and publish directly to Instagram.",
  },
];
...
function WaitlistModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      <div style={{
        background: BG_CARD, border: `1px solid ${BORDER_RG}`,
        ...
        <button
          ...
          style={{
            ...
            color: TEXT_MUTED, fontSize: "20px", lineHeight: 1, padding: "4px 8px",
          }}
        >
          ✕
        </button>
        ...
        {status === "done" ? (
          <div style={{ textAlign: "center", padding: "16px 0" }}>
            ...
            <h3 style={{ color: TEXT, fontSize: "22px", fontWeight: 700, marginBottom: "10px" }}>
              You're on the list.
            </h3>
            <p style={{ color: TEXT_MUTED, fontSize: "15px", lineHeight: 1.6 }}>
              We'll be in touch. Good things take a moment.
            </p>
            <button
              onClick={onClose}
              style={{
                marginTop: "28px", background: BORDER, color: TEXT,
          ...
          <>
            <h3 style={{ color: TEXT, fontSize: "22px", fontWeight: 700, marginBottom: "6px" }}>
              Join the waitlist
            </h3>
            <p style={{ color: TEXT_MUTED, fontSize: "14px", lineHeight: 1.6, marginBottom: "28px" }}>
              We're onboarding practices one by one. Tell us a bit about your clinic and we'll reach out when we're ready for you.
            </p>
            <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              <div>
                <label style={{ display: "block", fontSize: "12px", color: TEXT_MUTED, letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: "8px" }}>
                  Clinic name
                </label>
                <input
                  type="text"
                  ...
                  style={{
                    ...
                    borderRadius: "8px", padding: "12px 14px", color: TEXT,
              ...
              <div>
                <label style={{ display: "block", fontSize: "12px", color: TEXT_MUTED, letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: "8px" }}>
                  Anything else? <span style={{ textTransform: "none", opacity: 0.6 }}>(optional)</span>
                </label>
                <textarea
                  rows={3}
                  placeholder="How many clients do you manage? What's your biggest content headache?"
                  value={form.note}
              ...
              {status === "error" && (
                <p style={{ color: "#e07070", fontSize: "13px" }}>
              ...
              <button
                ...
                style={{
                  background: RG, color: "#fff", border: "none",
    ...
    <div style={{ background: BG, color: TEXT, fontFamily: "'League Spartan', 'Helvetica Neue', sans-serif", overflowX: "hidden" }}>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .rg-btn {
          background: ${RG}; color: #fff; border: none; border-radius: 8px;
      ...
      <nav style={{
        ...
        background: scrolled ? "rgba(19,19,19,0.92)" : "transparent",
        ...
        <div className="nav-inner" style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
            <button onClick={openModal} style={{
              background: "none", border: "none", cursor: "pointer",
              color: TEXT_MUTED, fontSize: "14px", fontFamily: "inherit",
              fontWeight: 500, padding: "8px 0", transition: "color 200ms",
            }}
            ...
            <Link href="/hub" className="ghost-btn" style={{ fontSize: "14px", padding: "9px 22px" }}>
              Log in
            </Link>
          </div>
        </div>
      ...
      <section style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", paddingTop: "64px" }}>
        ...
        <div style={{
          ...
          background: "radial-gradient(ellipse at center, rgba(196,147,127,0.08) 0%, transparent 70%)",
          pointerEvents: "none",
        }} />
        <div className="hero-inner" style={{
          ...
          <p style={{
            ...
            color: RG, fontWeight: 600, marginBottom: "28px",
          }}>
            Built for aesthetic clinics
          </p>
          <h1 className="hero-h1" style={{
            fontSize: "clamp(40px, 6vw, 68px)", fontWeight: 800,
            lineHeight: 1.08, color: TEXT, marginBottom: "28px",
            letterSpacing: "-0.02em", maxWidth: "820px", margin: "0 auto 28px",
          }}>
            The content platform built for aesthetic clinics
          </h1>
          <p style={{
            fontSize: "clamp(17px, 2.2vw, 21px)", color: TEXT_MUTED,
            lineHeight: 1.6, maxWidth: "580px", margin: "0 auto 44px",
            fontWeight: 400,
          }}>
            Social media management that understands the job. Generate, brand, schedule, and post — without burning through your Sundays.
          </p>
          <div style={{ display: "flex", gap: "14px", justifyContent: "center", flexWrap: "wrap" }}>
            <button onClick={openModal} className="rg-btn" style={{ fontSize: "16px", padding: "16px 38px" }}>
              Join the waitlist
            </button>
          </div>
          <p style={{
            marginTop: "20px", fontSize: "13px", color: TEXT_FAINT, fontWeight: 400,
          }}>
            100 hours saved per week. No lock-in.
          </p>
        </div>
      </section>
      ...
      <div style={{ borderTop: `1px solid ${BORDER}`, borderBottom: `1px solid ${BORDER}`, background: BG_STRIP }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "36px 40px", textAlign: "center" }}>
          <p style={{
            ...
            43 clinics. 100 hours saved per week. Built by someone who lived the job.
          </p>
        </div>
      </div>
      ...
      <section style={{ padding: "100px 0 80px" }}>
        <div className="section-inner" style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 40px" }}>
          <div style={{ marginBottom: "64px" }}>
            <p style={{
              fontSize: "12px", letterSpacing: "0.16em", textTransform: "uppercase",
              color: RG, fontWeight: 600, marginBottom: "16px",
            }}>
              How it works
            </p>
            <h2 style={{
          ...
          <div className="features-grid" style={{
            ...
            {FEATURES.map(({ Icon, title, desc }) => (
              <div key={title} className="feature-card">
                ...
                <p style={{ fontSize: "15px", color: TEXT_MUTED, lineHeight: 1.65 }}>
                  {desc}
                </p>
              </div>
            ))}
      ...
      {/* ── Testimonial / deeper social proof ─────────────────── */}
      <section style={{ padding: "80px 0", background: BG_STRIP, borderTop: `1px solid ${BORDER}` }}>
        <div className="section-inner" style={{ maxWidth: "780px", margin: "0 auto", padding: "0 40px", textAlign: "center" }}>
          <div style={{
            width: "40px", height: "2px", background: RG,
            margin: "0 auto 36px", borderRadius: "2px",
          }} />
          <blockquote style={{
            ...
            "I used to spend an entire day every week just making content. Now I do it in 90 minutes and it looks better than anything I made by hand."
          </blockquote>
          <p style={{ fontSize: "14px", color: TEXT_MUTED, letterSpacing: "0.06em", textTransform: "uppercase", fontWeight: 600 }}>
            Social media manager, aesthetic clinic group
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: "100px 0 120px" }}>
        <div className="section-inner" style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 40px", textAlign: "center" }}>
          <div style={{
            background: BG_CARD, border: `1px solid ${BORDER_RG}`,
            borderRadius: "20px", padding: "72px 40px",
            position: "relative", overflow: "hidden",
          }}>
            <div style={{
              position: "absolute", top: "-60px", left: "50%", transform: "translateX(-50%)",
              width: "600px", height: "300px",
              background: "radial-gradient(ellipse at center, rgba(196,147,127,0.07) 0%, transparent 70%)",
              pointerEvents: "none",
            }} />
            <p style={{
              fontSize: "12px", letterSpacing: "0.16em", textTransform: "uppercase",
              color: RG, fontWeight: 600, marginBottom: "20px",
            }}>
              Get early access
            </p>
            <h2 style={{
            ...
            <p style={{
              fontSize: "17px", color: TEXT_MUTED, marginBottom: "40px",
              lineHeight: 1.6, maxWidth: "460px", margin: "0 auto 40px",
            }}>
              We're onboarding practices one at a time. Join the list and we'll reach out when we're ready for you.
            </p>
            <button onClick={openModal} className="rg-btn" style={{ fontSize: "16px", padding: "16px 40px" }}>
              Join the waitlist
            </button>
          </div>
        </div>
      ...
      <footer style={{ borderTop: `1px solid ${BORDER}`, padding: "36px 0" }}>
        <div className="section-inner" style={{
          ...
          <p style={{ fontSize: "13px", color: TEXT_FAINT }}>
            © {new Date().getFullYear()} Social Media Sister · The CyberSuite
          </p>
          <div style={{ display: "flex", gap: "24px", alignItems: "center" }}>
            <Link href="/privacy" style={{ fontSize: "13px", color: TEXT_FAINT, textDecoration: "none", transition: "color 200ms" }}
              onMouseEnter={(e: React.MouseEvent<HTMLAnchorElement>) => (e.currentTarget.style.color = TEXT_MUTED)}
              onMouseLeave={(e: React.MouseEvent<HTMLAnchorElement>) => (e.currentTarget.style.color = TEXT_FAINT)}
            >
              Privacy
            </Link>
            <Link href="/terms" style={{ fontSize: "13px", color: TEXT_FAINT, textDecoration: "none", transition: "color 200ms" }}
              onMouseEnter={(e: React.MouseEvent<HTMLAnchorElement>) => (e.currentTarget.style.color = TEXT_MUTED)}
              onMouseLeave={(e: React.MouseEvent<HTMLAnchorElement>) => (e.currentTarget.style.color = TEXT_FAINT)}
            >
              Terms
            </Link>
            <Link href="/data-deletion" style={{ fontSize: "13px", color: TEXT_FAINT, textDecoration: "none", transition: "color 200ms" }}
              onMouseEnter={(e: React.MouseEvent<HTMLAnchorElement>) => (e.currentTarget.style.color = TEXT_MUTED)}
              onMouseLeave={(e: React.MouseEvent<HTMLAnchorElement>) => (e.currentTarget.style.color = TEXT_FAINT)}
            >
              Data Deletion
            </Link>
            <Link href="/hub" style={{ fontSize: "13px", color: TEXT_MUTED, textDecoration: "none", transition: "color 200ms" }}
              onMouseEnter={(e: React.MouseEvent<HTMLAnchorElement>) => (e.currentTarget.style.color = TEXT)}
              onMouseLeave={(e: React.MouseEvent<HTMLAnchorElement>) => (e.currentTarget.style.color = TEXT_MUTED)}
            >
              Log in
            </Link>
          </div>
