  ...
  return (
    <div style={{ background: "#000", minHeight: "100vh", color: "#fff", fontFamily: "'Inter', sans-serif" }}>
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        <h1 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 52, color: "#ff2d78", letterSpacing: 2, marginBottom: 8, lineHeight: 1 }}>Terms of Service</h1>
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div style={{ marginBottom: 40 }}>
      <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 26, color: "#ff2d78", letterSpacing: 1.5, marginBottom: 16 }}>{title}</h2>
