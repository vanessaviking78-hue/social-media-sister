...
export const clientPresetsTable = pgTable("client_presets", {
  ...
  subheadingFont: text("subheading_font"),
    hookUppercase: boolean("hook_uppercase").notNull().default(false),
    subheadingColor: text("subheading_color"),
    subheadingDropShadow: boolean("subheading_drop_shadow").notNull().default(false),
...
export const homeworkQuestionSetsTable = pgTable("homework_question_sets", {
  ...
  question4: text("question4").notNull().default(""),
  question5: text("question5").notNull().default(""),
  question6: text("question6").notNull().default(""),
  question7: text("question7").notNull().default(""),
  question8: text("question8").notNull().default(""),
  question9: text("question9").notNull().default(""),
  question10: text("question10").notNull().default(""),
...
export const homeworkRepliesTable = pgTable("homework_replies", {
  ...
  answer4: text("answer4").notNull().default(""),
  answer5: text("answer5").notNull().default(""),
  answer6: text("answer6").notNull().default(""),
  answer7: text("answer7").notNull().default(""),
